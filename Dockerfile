...
VOLUME /app/run/
ENTRYPOINT ["/bin/bash"]
# ENTRYPOINT ["gunicorn", "--bind", ":8000", "app.wsgi:application"]
# ENTRYPOINT [C:\Users\Rohit\DeepFake_final_code\Deepfake_detection_using_deep_learning\Django Application\bin\gunicorn_start.sh]